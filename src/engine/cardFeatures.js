...
function protection(o){const s=o.toLowerCase();return /hexproof|shroud|indestructible|phase out|protection from|\bward(?:\s*\{|\s*—|\b)|can't be the target of (?:spells|abilities)|counter target spell [^.]*targets?/.test(s)||(isBlinkText(o)&&/you control/.test(s))}
