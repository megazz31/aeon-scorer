...
function spellslinger(o){const s=withoutReminderText(o).toLowerCase();return /\bmagecraft\b/.test(s)||/\bwhenever you (?:cast|cast or copy|copy) (?:an? )?(?:instant|sorcery|noncreature) spell/.test(s)||/\b(?:instant|sorcery|noncreature) spells? you cast\b/.test(s)||/\binstant and sorcery spells? you cast\b/.test(s)||/\byou may cast (?:an? )?instant or sorcery spell\b/.test(s)||/\bcopy target instant or sorcery spell you control\b/.test(s)||/\bfirst (?:instant|sorcery|noncreature )?spell you cast\b/.test(s)}
