...
assert.equal(lowIntel.modelVersion,'deck-intelligence-v3')
...
console.log('P2-P7 ROADMAP MODELS OK — intelligence V3, share privacy, class Threat-Answer fallback, exact/large matchmaking, deck doctor and reality calibration contracts')
