...
assert.equal(lowIntel.modelVersion,'deck-intelligence-v4')
...
console.log('P2-P7 ROADMAP MODELS OK — intelligence V4, share privacy, class Threat-Answer fallback, exact/large matchmaking, deck doctor and reality calibration contracts')
